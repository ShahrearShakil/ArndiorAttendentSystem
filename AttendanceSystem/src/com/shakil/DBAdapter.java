...
public class DBAdapter 
{
	...
	public static final String KEY_ADMINUSN = "AdminUsn";
    ...
    private static final String DATABASE_CREATE3 =
        "create table admin_values (_id integer primary key autoincrement, Admin text not null, AdminUsn text not null, Pass1 text not null, Pass2 text not null);";
    ...
    public long insertAdminRecord(String admin, String adminusn, String pass1, String pass2) 
    {
    	long x;
    	
    	Log.i(TAG, "INSERTING AN ADMIN RECORD");
        ContentValues initialValues = new ContentValues();
        initialValues.put(KEY_ADMIN, admin);
        initialValues.put(KEY_ADMINUSN, adminusn);
        initialValues.put(KEY_PASS1, pass1);
        initialValues.put(KEY_PASS2, pass2);
        x=  db.insert(DATABASE_TABLE4, null, initialValues);
  ...
  //---retrieves a particular student record---
    ...
    {
    	Log.i("JJJ", "GETTING FACULTY RECORD");
    	Cursor mCursor =
    ...
    public Cursor getRecordByAdmin(String user) throws SQLException 
    {
    	Log.i("VVV", "GETTING ADMIN RECORD");
    	Cursor mCursor1 =
                db.query(true, DATABASE_TABLE4, new String[] {
                		...
                		null);
        if (mCursor1 != null) {
        	Log.i("Def", "cursor not null");
            mCursor1.moveToFirst();
        }
        return mCursor1;
    }
    
    public Cursor getRecordByAdmin1(String user) throws SQLException 
    {
    	Log.i("VVV", "GETTING ADMIN RECORD");
    	Cursor mCursor =
                db.query(true, DATABASE_TABLE4, new String[] {
    ...
    {
    	Log.i("III", "GETTING STUDENT RECORD");
    	Cursor mCursor =
    ...
    {
    	Log.i("GGG", "GETTING STUDENT RECORD");
    	Cursor mCursor =
    ...
    {
    	Log.i("FFF", "GETTING STUDENT RECORD");
    	Cursor mCursor =
                db.query(true, DATABASE_TABLE3, new String[] {
                		KEY_ROWID,
                		KEY_CODE,
    ...
    {
    	Log.i("EEE", "GETTING STUDENT RECORD by id");
    	Cursor mCursor =
                db.query(true, DATABASE_TABLE2, new String[] {
                		KEY_ROWID,
                		KEY_SNAME, 
    ...
    public void deleteStudentRecord(int id){
    	Log.i("DDD", "Trying To Delete Record");
    	
    	db.delete(DATABASE_TABLE2, KEY_ROWID+"="+id, null);
    }
    public void deleteFacultyRecord(int id){
    	Log.i("AAA", "Trying To Delete Record");
    	
    	db.delete(DATABASE_TABLE1,  KEY_ROWID+"="+id, null);
    	
    }
    public void deleteFacultyRecord1(String id) throws SQLException{
    	Log.i("BBB", "Trying To Delete Record");
    	String[] whereArgs = new String[] {id};
    	db.delete(DATABASE_TABLE2, KEY_CODE + "=?", whereArgs);
    	
    	
    }
    public void deleteFacultyRecord2(String id){
    	Log.i("CCC", "Trying To Delete Record");
    	
    	String[] whereArgs = new String[] {id};
    	db.delete(DATABASE_TABLE3, KEY_CODE + "=?", whereArgs);
